...
public class Stock_Functions_Controller implements Initializable{
	...
	@FXML
	public void show_display_stock_item() throws IOException{
		
		AnchorPane pane =FXMLLoader.load(getClass().getResource("Display_Stock.fxml"));
		yellow_pane.getChildren().setAll(pane);
	}
	...
	//	measure_text.setText(stock_item_combo.getValue());
		
	@FXML
	public void show_add_stock() throws IOException{
		
		AnchorPane pane =FXMLLoader.load(getClass().getResource("Add_Stock_Seperate.fxml"));
		yellow_pane.getChildren().setAll(pane);
	}
	...
	public void go_home(ActionEvent event) throws IOException{
	 ...
	 @FXML
		public void add_stock() throws SQLException{
			...
			if(stock_item_combo.getValue()==null || stock_quantity_text.getText().isEmpty()){
				
				invalid.setText("All details are not filled");
			}
			else{
